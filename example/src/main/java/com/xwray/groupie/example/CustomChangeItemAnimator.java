...
public class CustomChangeItemAnimator extends SimpleItemAnimator {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration())
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    // uses on rebind to the animation of oldHolder ... I don't know why ...
                    resetAnimation(holder);
    ...
    void cancelAll(List<RecyclerView.ViewHolder> viewHolders) {
        for (int i = viewHolders.size() - 1; i >= 0; i--) {
            try {
                ...
                Log.v(TAG, "cancelAll failed at index = " + i);
            }
        }
    }

    public static final String TAG = "CustomChangeItemAnimator";
